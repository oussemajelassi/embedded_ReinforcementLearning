...
int main(void)
{
	...
	HAL_StatusTypeDef HAL_MessageStatus = HAL_UART_Receive(&huart3, &RecievedData , 1 , 1 ) ;
	...
	/* add queues, ... */
	RL_OrdersQueue = xQueueCreate (10 , sizeof(int32_t) ) ;
	RL_ObservationsQueue = xQueueCreate(10 , sizeof ( RobotObservation ) ) ;
